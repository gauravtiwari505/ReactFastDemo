...
- candidate__email
- candidate__phone
- candidate__social_media: Extract a list of all social media profiles, blogs or websites.If the URLs are embedded within clickable text, ensure the full URL is displayed instead of just the text label.
